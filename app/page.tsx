...
Olá, eu sou Carlos
<span className='block text-primary mt-2 text-xl md:text-2xl lg:text-4xl'>
...
Estou a apenas uma mensagem de distância.
</p>
</div>
...
<h3 className='font-semibold text-sm sm:text-base mb-1'>Telefone</h3>
<a 
...
<div className='min-w-0 flex-1'>
<h3 className='font-semibold text-sm sm:text-base mb-1'>Localização</h3>
