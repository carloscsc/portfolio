    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            "rounded flex h-10 w-full border border-border bg-accent px-3 py-6 text-base file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-highlight disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
            error &&
